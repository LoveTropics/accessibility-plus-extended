...
public class DurabilityCheckerGui extends LightweightGuiDescription {
  ...
  public DurabilityCheckerGui(LocalPlayer player, Minecraft client) {
    this.player = player;
    this.client = client;
    ...
    WLabel label = new WLabel(new TranslatableComponent("gui.apextended.config.buttons.durabilitycheckersettings"), AccessibilityPlusExt.colors("red", 100));
